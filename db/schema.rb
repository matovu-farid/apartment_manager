...
ActiveRecord::Schema[7.0].define(version: 20_240_702_013_100) do
  ...
  create_table 'block_admins', force: :cascade do |t|
    ...
    t.index %w[user_id block_id], name: 'index_block_admins_on_user_id_and_block_id', unique: true
  ...
  create_table 'block_viewers', force: :cascade do |t|
    ...
    t.index %w[user_id block_id], name: 'index_block_viewers_on_user_id_and_block_id', unique: true
