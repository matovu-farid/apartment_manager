...
apartments = Apartment.create(
  [
    {price: 200000, floor: "5th", block: Block.first, name: "firstapartment"},
    {price: 200000, floor: "5th", block: Block.first, name: "secondapartment"}
  ]
)
...
rent_sessions = RentSession.create(
  [
